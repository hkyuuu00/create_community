...
<html>
    ...
    <body>
        ...
        ?>
        <center>
            <a href="./logout.php"><input type="button" value="로그아웃" style = "width: 80px; height: 25px; display: inline-block; position: relative; bottom: 79px; right: 500px;"></a>
                ...
                <table style = "border-collapse: collapse; position: absolute; left: 2.5px;">
                    <tr style = "text-align: center; font-size: 14px; font-weight: bold;">   
                        ...
                        while($row = mysqli_fetch_assoc($result3)){
                            ...
                            echo "<td style = 'width: 395px; text-overflow: ellipsis; overflow: hidden; white-space: nowrap;'>&nbsp;".$row['p_title']."</td>";
